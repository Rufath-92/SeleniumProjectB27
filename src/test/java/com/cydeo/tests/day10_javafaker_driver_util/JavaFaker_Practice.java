...
public class JavaFaker_Practice {
    ...
    public void java_faker_test(){
        ...
        System.out.println("faker.name().fullName() = " + faker.name().firstName());
        ...
        System.out.println("faker.chuckNorris().fact().replace(\"chuckNorris\",\"Firudin\") = " + faker.chuckNorris().fact().replace("Chuck Norris", "Firudin"));
