...
import com.cydeo.utilities.LoginPage_utility_vytrack;
...
public class vytrackAutoTest extends TestBase {
    ...
    @Test(priority = 1)
    public  void automation_Test_For_Driver() throws InterruptedException {
        ...
        for (Map.Entry<String,String> entry: users.entrySet()){
            LoginPage_utility_vytrack.login(driver, entry.getKey(), entry.getValue());
            ...
            LoginPage_utility_vytrack.logOut(driver);
            Thread.sleep(2000);
        }
    ...
    @Test(priority = 2)
    public void automation_Test_For_StoreManager() throws InterruptedException {
        driver.get("https://qa2.vytrack.com/user/login");
        ...
        for(Map.Entry<String,String> eachEntry : users.entrySet()){
            LoginPage_utility_vytrack.login(driver,eachEntry.getKey(),eachEntry.getValue());
